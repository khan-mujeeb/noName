...
const HeroSection = () => {
    ...
    return (
        ...
        <div id="hero" className="select-none h-full flex justify-center items-center lg:max-3xl:gap-28 mt-10 lg:max-3xl:flex-row flex-col gap-10">
            ...
            <div className="flex flex-col items-center justify-center lg:max-3xl:gap-6 lg:max-3xl:w-96 gap-2 w-80">
                ...
                <div className="flex items-center gap-2 font-semibold text-text_secondary">
                    <h4 className=" lg:max-3xl:text-xl text-md">{"Hello, I'm"}</h4>
                </div>

                {/* name  */}
                <h1 className=" font-semibold lg:max-3xl:text-[3rem] text-2xl">Mujeeb Khan</h1>
                ...
                <div className="flex gap-6 mt-1">
                    <a href= {resume} download={"mujeeb_khan_resume"} className="flex items-center justify-center rounded-3xl bg-white p-2 border-black border-2 hover:bg-black hover:text-white transition-all duration-700 font-semibold lg:max-3xl:p-3 lg:max-3xl:text-md text-sm">
                        Download CV
                    </a>
