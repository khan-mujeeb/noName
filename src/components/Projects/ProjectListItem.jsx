...
const ProjectListItem = ({ project }) => {
    return (
        <div
            key={project.id}
            className="sm:max-3xl:w-[550px]  md:max-3xl:p-10 p-3 w-80 rounded-xl shadow-md shadow-gray-900 transition duration-300 hover:bg-stone-100 backdrop-blur-sm"
        >
